window.onload = mladdevents;
			...
			function mloverSetTimeout(e){	
				...
				alert(the_e);	    		
				window.mlTimeout = setTimeout(function(){mlover(the_e)},100);
			}			
			function mlover(e){
				...
				if(ob[0] && under == false){				
					if(window.lastover != ob[0]){
						...
						//alert(ob[0].offsetParent.offsetTop + ob[0].offsetTop);
						if (ob[0].style.top == '' && (ob[0].offsetParent.offsetTop + ob[0].offsetTop) != 77){
							var tope = ob[0].offsetTop -(ob[0].offsetHeight /2)+ 10;
							if (tope < 0){
								tope = 2;
							}
							ob[0].style.top = tope;
