							...
							<TD vAlign="top">
								<TABLE id="Table3" class="infoMacro" width="99%">
									...
									<TR>
										...
										<TD>
                                            <asp:TextBox ID="txtExpedienteID_min0" runat="server" CssClass="inpform" Width="298px"></asp:TextBox>
                                        </TD>
									</TR>
									<TR>
										<TD style="HEIGHT: 22px">
											<asp:Label id="lblTramiteID" runat="server" CssClass="Etiqueta1" Width="71px" Height="16px">Trabajo Tipo</asp:Label></TD>
										<TD style="HEIGHT: 22px">
