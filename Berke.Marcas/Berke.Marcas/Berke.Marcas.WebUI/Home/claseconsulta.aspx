						...
						<TD width="100%">
							<asp:datagrid id="dgResult" runat="server" Width="100%" CssClass="tbl" HorizontalAlign="Center"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="NizaAbrev" HeaderText="Edición" Visible="true"></asp:BoundColumn>
									<asp:BoundColumn DataField="Nro" HeaderText="Clase Nro." Visible="true"></asp:BoundColumn>
									<asp:BoundColumn DataField="Descrip" ItemStyle-HorizontalAlign="Left" HeaderText="Descripción"></asp:BoundColumn>
								</Columns>
							</asp:datagrid></TD>
					</TR>
				</TABLE>
