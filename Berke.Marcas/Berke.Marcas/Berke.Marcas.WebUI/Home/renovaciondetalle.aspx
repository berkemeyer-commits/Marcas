...
<%@ Page language="c#" smartnavigation="True" validateRequest="false" Inherits="Berke.Marcas.WebUI.Home.RenovacionDetalle" CodeFile="RenovacionDetalle.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<P><FONT face="Verdana" size="4"><STRONG>Hoja de Inicio de Renovación&nbsp;
							...
							<TD style="WIDTH: 100%; HEIGHT: 25px" width="100%">
								...
								<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
									<TR>
										<TD width="1%"><IMG src="../tools/imx/ang_sup_izq.bmp"></TD>
										<TD class="titletable1" width="99%" bgColor="#7bb5e7">
											<asp:Label id="lTotalMarcas" runat="server" Font-Bold="True">Marcas Renovadas : </asp:Label></TD>
									</TR>
								</TABLE>
								<asp:DataGrid id="dgMarcasAsignadas" runat="server" Width="100%" Height="53px" AutoGenerateColumns="False">
									...
									<Columns>
										...
										<asp:BoundColumn DataField="LogotipoID" HeaderText="ID de logo">
											<ItemStyle Font-Size="14pt" Font-Bold="True"></ItemStyle>
										</asp:BoundColumn>
										<asp:ButtonColumn Visible="False" Text="Eliminar" HeaderText="Acci&#243;n" CommandName="Delete"></asp:ButtonColumn>
										<asp:TemplateColumn HeaderText="">
											<ItemTemplate>
												<asp:label id="Label1" Visible="True" runat="server" text='<%# String.Format( @"<A href=""DetalleHojaDescriptiva.aspx?ExpedienteId={0}"">Ver Hoja Descriptiva</A>", DataBinder.Eval(Container.DataItem, "ExpedienteId"))%>'>
												</asp:label>
											</ItemTemplate>
										</asp:TemplateColumn>
									</Columns>
								...
								<asp:DataList id="dtlMarcasAsignadas" runat="server" Width="100%" CssClass="Grilla" HorizontalAlign="Center">
									<ItemTemplate>
										<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR class="EstiloItem">
												<TD align="right" width="20.26%"><FONT face="Verdana" size="1"><STRONG>Denominación Clave</STRONG></FONT>
												</TD>
												<TD style="WIDTH: 2.55%; HEIGHT: 26px"></TD>
												<TD align="left">
													<asp:label id=lblDenominacionClave runat="server" Font-Size="Medium" Font-Bold="True" text='<%# DataBinder.Eval(Container.DataItem, "DenominacionClave") %>'>
													</asp:label></TD>
											</TR>
											<TR class="EstiloItem">
											...
											<TR class="EstiloItem">
												...
												<TD align="left">
													...
													<asp:label id=Label13 runat="server" Visible="True" text='<%# String.Format( @"<A href=""DetalleHojaDescriptiva.aspx?ExpedienteId={0}"">Ver Hoja Descriptiva</A>", DataBinder.Eval(Container.DataItem, "ExpedienteId"))%>'>
													</asp:label></TD>
											</TR>
											<TR class="EstiloItem">
												<TD align="right" width="20.26%"><FONT face="Verdana" size="1"><STRONG>Clase Anterior</STRONG></FONT>
												</TD>
												<TD style="WIDTH: 2.55%; HEIGHT: 26px"></TD>
												<TD align="left">
											...
											<TR class="EstiloItem">
												<TD align="right" width="20.26%"><FONT face="Verdana" size="1"><STRONG>Clase Nueva</STRONG></FONT>
												</TD>
												<TD style="WIDTH: 2.55%; HEIGHT: 26px"></TD>
												<TD align="left">
													<asp:label id=Label8 runat="server" Font-Bold="True" text='<%# DataBinder.Eval(Container.DataItem, "ClaseDescrip") %>'>
													</asp:label>&nbsp; Limitada:
													<asp:CheckBox id=Checkbox2 Runat="server" Enabled="False" Checked='<%# DataBinder.Eval(Container.DataItem, "Limitada")%>'>
													</asp:CheckBox></TD>
											</TR>
											<TR class="EstiloItem">
											...
											<TR class="EstiloItem">
												<TD align="right" width="20.26%"><FONT face="Verdana" size="1"><STRONG>Fec.Vto.Reg.</STRONG></FONT>
												</TD>
												<TD style="WIDTH: 2.55%; HEIGHT: 26px"></TD>
												<TD align="left">
											...
											<TR class="EstiloItem">
												<TD align="right" width="20.26%"><FONT face="Verdana" size="1"><STRONG>Etiqueta</STRONG></FONT>
												</TD>
												<TD style="WIDTH: 2.55%; HEIGHT: 26px"></TD>
												<TD align="left">
													<asp:Label id="lblLogo" runat="server">Logotipo</asp:Label></TD>
											</TR>
										</TABLE>
									</ItemTemplate>
									<SeparatorTemplate>
