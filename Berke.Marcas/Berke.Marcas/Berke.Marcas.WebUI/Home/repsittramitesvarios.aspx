...
<%@ Page language="c#" Inherits="Berke.Marcas.WebUI.Home.repSitTramitesVarios" CodeFile="repSitTramitesVarios.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Header" Src="../Tools/Controls/Header.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>repSitTramitesVarios</title>
...
function restablecer(pCod){
  ...
  window.close();
   ...
   /-->
			...
			<P class="titulo">Trámites Varios Ingresados</P>
			<!-- 
