...
<%@ Page language="c#" Inherits="Berke.Marcas.WebUI.Home.REP_39" CodeFile="REP_39.aspx.cs" %>
...
<HTML>
   ...
   /-->
			...
			<P class="titulo"><asp:label id="lblTitulo" runat="server" >Marcas Nuestras Registradas y en Tramite </asp:label><asp:label id="lblTituloAclaracion" runat="server" >( Por Propietario. P/ Enviar )</asp:label></P>
			<!-- 
