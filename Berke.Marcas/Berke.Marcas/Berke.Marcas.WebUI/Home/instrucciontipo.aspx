...
<%@ Page language="c#" Inherits="Berke.Marcas.WebUI.Home.InstruccionTipo" CodeFile="InstruccionTipo.aspx.cs" %>
...
<HTML>
   ...
   /-->
			...
			<P class="titulo">Consultar Instrucciones</P>
			<!-- 
...
--><asp:panel id="pnlResultado" runat="server" Visible="True">
				...
				<TABLE cellSpacing="0" cellPadding="0" width="98%" align="center">
					...
					<TR>
						<TD width="100%">
							<asp:datagrid id="dgResult" runat="server" HorizontalAlign="Center" DataKeyField="ID" AutoGenerateColumns="False"
