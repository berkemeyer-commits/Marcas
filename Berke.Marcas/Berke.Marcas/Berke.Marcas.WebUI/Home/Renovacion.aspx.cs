...
namespace Berke.Marcas.WebUI.Home
{
	...
	public partial class Renovacion : System.Web.UI.Page
	{
		...
		private void AsignarEventos()
		{
			...
			this.bDescripcion.Click += new System.EventHandler(this.bDescripcion_Click);
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if( !IsPostBack )
			{
				...
				inTB.NewRow(); 
				inTB.Dat.Entero			.Value = GlobalConst.EdicionesNiza.EDICION_VIGENTE;//Const.NIZAEDICIONID_VIGENTE;   //Int32
				inTB.PostNewRow(); 
		...
		private void RecuperarDatos (int OtID) 
		{
			...
			rblTipoAtencion.SelectedIndex = outDG.OrdenTrabajo.Dat.TipoAtencionxMarca.AsInt;
			...
			if (outDG.OrdenTrabajo.Dat.TipoAtencionxMarca.AsInt == (int)GlobalConst.TipoAtencionxMarca.ATENCIONXBUNIT)
			{
				...
				bussinessUnit.Dat.ClienteID.Filter = outDG.OrdenTrabajo.Dat.ClienteID.AsInt;
				...
				ddlBussinessUnit.SelectedValue = outDG.OrdenTrabajo.Dat.IDTipoAtencionxMarca.AsString;
		...
		private void btnAsignarMarcas_Click(object sender, System.EventArgs e)
		{
            ...
            txtDenominacionClave.Text = Berke.Libs.Boletin.Libs.Utils.LimpiarDenominacionClave(vRenovacionMarca.Dat.MarcaTipoID.AsInt, vRenovacionMarca.Dat.Denominacion.AsString);
			...
			if(vRenovacionMarca.Dat.ClaseEdicionID.AsInt == (int)GlobalConst.EdicionesNiza.EDICION_VIGENTE)//Const.NIZAEDICIONID_VIGENTE) 
			{
		...
		protected void BntGrabar_Click(object sender, System.EventArgs e)
		{
			...
			Berke.DG.ViewTab.ParamTab outTB =  Berke.Marcas.UIProcess.Model.Renovacion.Upsert( inDG );
			if (outTB.Dat.Logico.AsBoolean) 
			{
				string pagconfirmacion = "RenovacionDetalle.aspx?OtID=" + outTB.Dat.Entero.AsString;
		...
		{		
			...
			if (rblTipoAtencion.SelectedIndex != (int)GlobalConst.TipoAtencionxMarca.ATENCIONXBUNIT)
			{
		...
		private void BntMarcasGrabar_Click(object sender, System.EventArgs e)
		{
            ...
            vRM.Dat.DenominacionClave.Value = Berke.Libs.Boletin.Libs.Utils.LimpiarDenominacionClave(vRM.Dat.MarcaTipoID.AsInt, txtDenominacion.Text);
        ...
        private void HandleChkDerechoPropio()
        {
            if (chkDerechoPropio.Checked == true)
            {
		...
		{		
			...
			if(vRM.Dat.ClaseEdicionID.AsInt == (int)GlobalConst.EdicionesNiza.EDICION_VIGENTE) 
			{
